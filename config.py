...
class ProductionConfig(Config):
    SQLALCHEMY_DATABASE_URI = "postgresql://postgres:Cabra_2023_Bobo@abcjobsdbinstancias.ckdctflafdko.us-east-2.rds.amazonaws.com:5432/CandidatoBD"
...
class DevelopmentConfig(Config):
    SQLALCHEMY_DATABASE_URI = 'postgresql://admin:admin@localhost:5432/CandidatoBD'
    JWT_ACCESS_TOKEN_EXPIRES = False
...
class StagingConfig(Config):
    SQLALCHEMY_DATABASE_URI = "postgresql://postgres:Cabra_2023_Bobo@abcjobsdbinstancias.ckdctflafdko.us-east-2.rds.amazonaws.com:5432/CandidatoTestBD"
    JWT_ACCESS_TOKEN_EXPIRES = False
...
class TestingConfig(Config):
    DEBUG = True
    TESTING = True
    SQLALCHEMY_DATABASE_URI = 'postgresql://admin:admin@localhost:5432/CandidatoTestBD'
    JWT_ACCESS_TOKEN_EXPIRES = False
